...
faceCascade = cv2.CascadeClassifier(r'C:\Users\HP\Desktop\AI-based-attendance-presence-calculation-using-AWS-main\Codes\haarcascade_frontalface_default.xml') # xml file to detect the faces 
...
def photo():
    ...
    for fileName in fileNames:
        ...
        for match in faceMatches:
            ...
            url = "https://wr6bbq99p6.execute-api.us-east-2.amazonaws.com/attendance_input="+name+"&period="+period
